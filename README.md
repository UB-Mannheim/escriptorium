...
You should be able to access the website on http://localhost:8080/
...
it is recomanded to then make an alias for manage.py
...
The website should be accessible on localhost:8000
